...
Подробная инструкция по деплою на продакшн сервер:

📖 **[См. полную инструкцию по деплою](./DEPLOY_PRODUCTION.md)**

🔍 **[Диагностика проблем на продакшне](./TROUBLESHOOTING.md)** - если приложение упало

### Краткая последовательность:

1. Подключиться к серверу: `ssh root@91.210.170.148`
2. Перейти в директорию: `cd /home/project/gustaw-fin`
3. Получить изменения: `git pull origin production`
4. Установить зависимости: `npm install`
5. Применить миграции: `npx prisma db push`
6. Собрать проект: `npm run build`
7. Перезапустить: `pm2 restart gustaw --update-env`

**Ветка**: `production`  
**Сервер**: `91.210.170.148`  
**Домен**: `https://gustaw.ru`

---

## 🏃 Startup Guide (локальная разработка)
